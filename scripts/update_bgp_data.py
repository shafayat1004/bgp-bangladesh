...
def build_viz_data(analysis, asn_info, country_asns):
    """Build 3-layer visualization data from analysis results."""
...
def main():
    ...
    # Build visualization data
    viz_data = build_viz_data(analysis, asn_info, country_asns)
